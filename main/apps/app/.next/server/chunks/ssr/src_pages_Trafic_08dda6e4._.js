    ...
    const asyncGetTrafic = async ()=>{
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                const res = !data ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$ui$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPackUi"])().reverse() : data.data;
                setPackets((prev)=>[
                        ...res,
                        ...prev
                    ]);
