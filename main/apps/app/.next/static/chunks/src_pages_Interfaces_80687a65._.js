...
_s(useNetworkData, "zK7QMswwa/z3Qp//POvzzTBbYXg=", false, function() {
    return [
...
function InterfacesPage() {
    _s();
    const { idKey, interfaces, stats } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$Interfaces$2f$model$2f$useNetworkData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNetworkData"])();
...
_s(InterfacesPage, "grz+xFXUoqOGE3ozecdXG16opT4=", false, function() {
    return [
