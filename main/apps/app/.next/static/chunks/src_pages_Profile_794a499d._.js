...
function useSettings() {
    ...
    const settings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "useSettings.useSelector[settings]": (state)=>state.settings
    }["useSettings.useSelector[settings]"]);
    ...
    const onAddUser = async ()=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/signup", payload);
            ...
            const errorMsg = ((_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.message) || "Произошла ошибка при добавлении пользователя";
            alert(errorMsg);
        } finally{
            setIsLoading(false);
        }
...
_s(useSettings, "yhcjQEqJ86kZbc0OP0kZNCmKuxI=", false, function() {
    return [
...
function ProfilePage() {
    _s();
    const { name, role, open, setOpen, onAddUser, newUsername, setNewUsername, newName, setNewName, newRole, setNewRole, newPassword, setNewPassword, isLoading, onExit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$Profile$2f$model$2f$useSettings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSettings"])();
...
_s(ProfilePage, "lukTIP0kIy8oPwviqrp79EyIGL4=", false, function() {
    return [
