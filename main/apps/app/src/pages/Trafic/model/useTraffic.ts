...
export const MOCK_PACKETS: PacketInfo[] = [
  {
    ...
    network: { version: "IPv4", srcIP: "192.168.0.2", dstIP: "192.168.0.1", protocol: "UDP" },
  ...
  },
  {
    ...
    network: { version: "IPv4", srcIP: "192.168.0.2", dstIP: "8.8.8.8", protocol: "TCP" },
  ...
  },
  {
    ...
    network: { version: "IPv4", srcIP: "192.168.0.3", dstIP: "142.250.74.14", protocol: "TCP" },
  ...
  },
  {
    ...
    network: { version: "IPv4", srcIP: "192.168.0.4", dstIP: "1.1.1.1", protocol: "ICMP" },
  ...
  },
  {
    ...
    network: { version: "IPv4", srcIP: "192.168.0.5", dstIP: "172.217.16.206", protocol: "TCP" },
  ...
  },
  {
    ...
    network: { version: "IPv4", srcIP: "192.168.0.7", dstIP: "93.184.216.34", protocol: "TCP" },
  ...
  },
  {
    ...
    network: { version: "IPv4", srcIP: "192.168.0.8", dstIP: "192.168.0.255", protocol: "UDP" },
  ...
  },
  {
    ...
    network: { version: "IPv4", srcIP: "192.168.0.9", dstIP: "151.101.1.69", protocol: "TCP" },
...
export function useTraffic() {
  const idKey = useId();
  const [packets, _setPackets] = useState<PacketInfo[]>(MOCK_PACKETS);
